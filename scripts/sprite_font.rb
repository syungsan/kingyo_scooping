...
class SpriteFont < Sprite
  ...
  def initialize(x=0, y=0, text="sample", font_size=24, font_color=[255, 255, 255], frame_color=[0, 0, 0, 0], option={},
    ...
    option = {:font_name=>"ＭＳ Ｐゴシック", :weight=>400, :italic=>false, :auto_fitting=>false, :edge=>false, :edge_color=>[0, 0, 0],
...
if __FILE__ == $0 then
  ...
  sprite_font = SpriteFont.new(0, 0, "これはテストです。", 18, C_RED, C_DEFAULT, {:shadow=>true, :shadow_color=>[128, 128, 128, 128]})

  ...
  module Editor
    ...
    class JSONTreeView < Gtk::TreeView
      ...
      def ask_for_hash_pair(parent)
        ...
        hbox.pack_start(Fonts.new("Key:"), false)
        ...
        hbox = HBox.new(false, 5)
        hbox.pack_start(Fonts.new("Type:"), false)
        ...
        hbox = HBox.new(false, 5)
        hbox.pack_start(Fonts.new("Value:"), false)
      ...
      def ask_for_order
        ...
        hbox.pack_start(Fonts.new("Order:"), false)
      ...
      def ask_for_find_term(search = nil)
        ...
        hbox.pack_start(Fonts.new("Regex:"), false)
    ...
    class MainWindow < Gtk::Window
      ...
      def ask_for_location
        ...
        hbox.pack_start(Fonts.new("Location:"), false)
